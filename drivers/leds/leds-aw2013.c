...
int aw2013_set_color_singlecolor(struct aw2013_dev_data *aw2013)
{
	...
	{
		blink_flag = 0x10;
                aw2013_i2c_write(0x0,0x54);//reset part of register//zhangpu.wt,ADD,2015.8.24,add led update
	}
	...
	if(red_on || green_on || blue_on)
	{
		if(0 == aw2013_has_inited){
			...
			mdelay(1);
			aw2013_has_inited = 1;  //zhangpu.wt,ADD,2015.8.24,add led update 
		}
		...
		aw2013_i2c_write(0x01, 0xe1);		// enable LED 	
                ...
                switch (tp_color) {
                case 0x31:   //white
                if(red_on)aw2013_i2c_write(0x31, blink_flag|0x63);
		if(green_on)aw2013_i2c_write(0x32, blink_flag|0x63);	
		...
		printk("tp_color is golden\n");
                break;
                default:		
		if(red_on)aw2013_i2c_write(0x31, blink_flag|0x62);
		if(green_on)aw2013_i2c_write(0x32, blink_flag|0x62);	
		if(blue_on)aw2013_i2c_write(0x33, blink_flag|0x62);
